...
public enum IllustrationDrawStyle {
  PHOTO_REALISTIC(
      "photoRealistic",
      "Create a close-up, photorealistic studio portrait "
  ...
  OLD_SCHOOL(
      "oldSchool",
      "Generate an old-school, black and white, "
  ...
  FANTASY_ART(
      "fantasyArt",
      "Generate a highly detailed and artistic "
  ...
  ANIME(
      "anime",
      "Create a studio portrait of a mature-looking individual in a "
  ...
  CARTOON(
      "cartoon",
      "Generate a vibrant and expressive studio portrait of a "
  ...
  STEAMPUNK(
      "steampunk",
      "Generate a detailed studio portrait of a "
  ...
  GOTHIC(
      "gothic",
      "Create a dark and dramatic studio portrait of a "
  ...
  WATERCOLOUR(
      "watercolour",
      "Generate a soft and ethereal studio portrait of a "
  ...
  PIXEL_ART(
      "pixelArt",
      "Create a retro-inspired studio portrait of a "
  ...
  COMIC_BOOK(
      "comicBook",
      "Generate a dynamic and bold studio portrait of a "
  ...
  MINIMALIST(
      "minimalist",
      "Create a clean and elegant studio portrait of a "
  ...
  ABSTRACT(
      "abstract",
      "Generate an artistic and interpretive studio portrait of a "
  ...
  OIL_PAINTING(
      "oilPainting",
      "Create a rich and textured studio portrait of a "
  ...
  PENCIL_SKETCH(
      "pencilSketch",
      "Generate a raw and expressive studio portrait of a "
  ...
  IMPRESSIONISTIC(
      "impressionistic",
      "Create a vibrant and evocative studio portrait "
  ...
  SURREALIST(
      "surrealist",
      "Generate a dreamlike and imaginative studio portrait of "
  ...
  CONCEPT_ART(
      "conceptArt",
      "Create a dynamic and imaginative studio portrait of a "
  ...
  CHILDREN_BOOK(
      "childrenBook",
      "Generate a charming and whimsical studio portrait "
  ...
  UKIYO_E(
      "ukiyoE",
      "Create a stylistic studio portrait of a mature-looking "
  ...
  ART_NOUVEAU(
      "artNouveau",
      "Generate an elegant and flowing studio portrait of a "
  ...
  DYSTOPIAN(
      "dystopian",
      "Create a grim and atmospheric studio portrait of a "
   ...
   * IllustrationDrawStyle.fromKeyOrDefault(character_context.context_draw_style) If the key is not
   * found, returns a default style (e.g., PHOTO_REALISTIC).
   *

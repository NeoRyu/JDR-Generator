    ...
    static {
        try {
            ...
            FontFactory.register(
                    Objects.requireNonNull(
                                    PdfGeneratorService.class.getResource(
                                            "/fonts/playwrite-fr-moderne-light.ttf"))
                            .getFile(),
                    "GooglePlayWriteFrModerneLight");
            FontFactory.register(
                    Objects.requireNonNull(
                                    PdfGeneratorService.class.getResource(
                                            "/fonts/playwrite-fr-moderne-regular.ttf"))
                            .getFile(),
                    "GooglePlayWriteFrModerneRegular");
            FontFactory.register(
                    Objects.requireNonNull(
                                    PdfGeneratorService.class.getResource(
                                            "/fonts/playwrite-fr-moderne-thin.ttf"))
                            .getFile(),
    ...
    private static class CharacterPdfPageEvent extends PdfPageEventHelper {
        ...
        public void onEndPage(PdfWriter writer, Document document) {
            ...
            if (footerBaseFont != null) { // S'assure que la police a été chargée
                ...
                float pageNumTextWidth =
                        footerBaseFont.getWidthPoint(pageNumText, footerFont.getSize());
        ...
        try {
            ...
            try {
                ...
                InputStream imageStream =
                        getClass().getClassLoader().getResourceAsStream(bgImg_Sheet);
                if (imageStream != null) {
            ...
            CharacterPdfPageEvent event =
                    new CharacterPdfPageEvent(parchmentImage, c_details, c_context);
            ...
            if (c_details != null && c_context != null) {
                ...
                document.addSubject(
                        "JDR-Generator : https://github.com/NeoRyu/JDR-Generator/tree/main");
            ...
            try {
                ...
                if (portraitImageStream != null) {
                    portraitCellBackgroundImage =
                            Image.getInstance(portraitImageStream.readAllBytes());
                    imageCell.setCellEvent(
                            new PortraitCellBackgroundEvent(portraitCellBackgroundImage));
                } else {
            ...
            try {
                if (c_illustration != null
                    ...
                    imageCell.addElement(
                            new Paragraph("Aucun portrait n'a été généré...", infoError));
                }
            } catch (IOException e) {
            ...
            document.add(
                    paragraph(0, "Raison de la résidence", c_details.getReasonForResidence(), 9));
            ...
            document.add(
                    paragraph(
                            0, "Parents en vie ?", c_details.getParentsAlive() ? "Oui" : "Non", 9));
            document.add(
                    paragraph(0, "Détails sur les parents", c_details.getDetailsAboutParents(), 9));
            document.add(
                    paragraph(
                            0,
            ...
            document.add(
                    paragraph(0, "Raison de la profession", c_details.getReasonForProfession(), 9));
            ...
            document.add(
                    paragraph(0, "Surmonter les obstacles", c_details.getOvercomingObstacle(), 9));
            ...
            document.add(
                    paragraph(0, "Description de la personne", c_details.getSelfDescription(), 9));
            document.add(paragraph(0, "Signe distinctif", c_details.getDistinctiveTrait(), 9));
            document.add(
                    paragraph(0, "Description Physique", c_details.getPhysicalDescription(), 9));
            document.add(
                    paragraph(
                            0, "Préférence vestimentaire", c_details.getClothingPreferences(), 9));
            ...
            if (c_json_data != null
                ...
                try {
                    ...
                    LOGGER.error(
                            "Erreur lors du parsing du JSON des statistiques" + e.getMessage());
            ...
            if (value instanceof ArrayList<?>) {
                ...
                for (int i = 0; i < list.size(); i++) {
                    ...
                    if (item instanceof Map) {
                        ...
                        document.add(
                                paragraph(
                                        level, String.valueOf(item), "", calcFontSize(14, level)));
                    }
                }

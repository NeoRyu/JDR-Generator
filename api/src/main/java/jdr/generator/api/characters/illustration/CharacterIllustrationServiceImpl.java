...
public class CharacterIllustrationServiceImpl implements CharacterIllustrationService {
        ...
        .orElseThrow(
            () ->
                new RuntimeException(
                    "Illustration not found for character details ID: " + characterDetailsId));
  }
  ...
  public CharacterIllustrationEntity updateIllustration(
    ...
    CharacterIllustrationEntity illustrationToUpdate = findByCharacterDetailsId(characterDetailsId);
